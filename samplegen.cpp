...
void Synth::create_sample_radians(SynthWrapper *synfunc, double *sam, double *ssum, double *ls){
	int notes_playing = 0;
	double AMP_MAX = 1.0;
	double amp = 1.0;
...
double Synth::normalize_radians(double ssum, int notes_playing, double *amp, double AMP_MAX){
